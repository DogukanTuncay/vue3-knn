...
<footer class="fixed bottom-0 left-0 z-20 w-full mt-20 p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-center md:p-6 dark:bg-gray-800 dark:border-gray-600">
